...
class KMeansClustering:
    ...
    def elbow_plot(self,data):
        ...
        self.logger.logs('logs','clustering','entered into elbow_plot method of clustering class ')
        ...
        try:
            ...
            self.logger.logs('logs','clustering','optimum no of cluster '+str(self.kn.knee))
            ...
            """
            self.logger.logs('logs','clustering','Exception occured in elbow plot method of KMeansCluster class, Exception : '+str(e))
            raise e
    ...
    def create_clusters(self,data,number_of_clusters):
        ...
        self.logger.logs('logs','clustering','entered into create_clusters method of KMeansCluster class ')
        ...
        try:
            ...
            self.logger.logs("logs","clustering","sucessfully created "+str(number_of_clusters)+"clusters")
            ...
            """
            self.logger.logs("logs","clustering","Exception occured in create_clusters method of the KMeansClustering class,Exception Message : "+str(e))
            self.logger.logs("logs","clustering","Fitting the data to clusters failed. Exited the create_clusters method of the KMeansClustering class")
