...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        self.logger.logs('logs','training',' Entered into get_best_params_for_random_forest method of model finder class')
        ...
        try:
            ...
            self.logger.logs('logs','training','Random Forest best params: '+str(self.grid.best_params_))
            ...
            """
            self.logger.logs('logs','training','Exception occured in get_best_params_for_random_forest Exception : '+str(e))
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        self.logger.logs('logs','training','entered into get_best_params_for_xgboost ')
        ...
        try:
            ...
            self.logger.logs('logs','training','XGBoost best params: ' + str(self.grid.best_params_))
            ...
            self.logger.logs('logs','training','Exception occured in get_best_params_for_xgboost method of the Model_Finder class. Exception : '+str(e))
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            if len(test_y.unique()) == 1: #if there is only one label in y, then roc_auc_score returns error. We will use accuracy in that case
                ...
                self.logger.logs('logs','training','Accuracy for XGBoost:' + str(self.xgboost_score))


            else:
                self.xgboost_score = roc_auc_score(test_y, self.prediction_xgboost) # AUC for XGBoost
                # self.logger_object.log(self.file_object, 'AUC for XGBoost:' + str(self.xgboost_score)) # Log AUC
                self.logger.logs('logs','training','AUC for XGBoost: ' + str(self.xgboost_score))
            ...
            if len(test_y.unique()) == 1:#if there is only one label in y, then roc_auc_score returns error. We will use accuracy in that case
                ...
                self.logger.logs('logs','training','Accuracy for RF:' + str(self.random_forest_score))
                ...
                self.logger.logs('logs','training','AUC for RF:' + str(self.random_forest_score))
            ...
            self.logger.logs('logs','training','Exception occured in get_best_model method of the Model_Finder class. Exception :'+str(e))
